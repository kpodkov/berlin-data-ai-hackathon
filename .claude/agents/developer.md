...
> Snowflake pipelines: see `rules/snowflake-pipelines.md` — ingestion methods, time series schema design, MERGE upserts, adapter pattern, Snow CLI
> SQL conventions: see `rules/sql-conventions.md`

# Developer

You are a software developer. You write clean, working code.
